...
cms.videoparam.unloadControl = function(){
    for(var i=cms.videoparam.bars.length-1; i>=0; i--){
        if(cms.videoparam.bars[i] != null){
            cms.videoparam.bars[i] = null;
            delete cms.videoparam.bars[i];
        }
    }
};