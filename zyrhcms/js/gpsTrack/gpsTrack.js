...
var rightWidth = rightWidthConfig =  360;
var switchWidth = 5;
var boxSize = {};
var boxId = 'pwbox001';
//列表框最小宽度
...
cms.gpstrack.searchFormPanelH = 212;
...
var setGpsDevice = function(param){
    ...
    cms.gpstrack.curDevCode = param.devCode;
...
var setBodySize = function(){
    ...
    boxSize = {
        width: frameSize.width - leftWidth - rightWidth - switchWidth*2 - borderWidth, 
...
var setRightPanelSize = function(){
    //$('#divSearchForm').height(cms.gpstrack.searchFormPanelH - 25 - 3);
    $('#divSearchForm').height(92);
    $('#divTrackForm').height(cms.gpstrack.searchFormPanelH - 25 - 3 - 92);
    $('.listbox').width(rightWidth - 2);
    if(cms.util.isIE6){
...
cms.gpstrack.showDevPrompt = function(){
    var strHtml = '请在左边栏“设备列表”中选择设备。<br />'
        + '<span style="color:#008000;">怎么选择设备？<br />鼠标双击“设备列表”中的设备名称即可。</span>';
...
cms.gpstrack.getGpsTrack = function(){
    ...
    var urlparam = 'action=getDeviceGpsTrack'
        + '&devCode=' + devCode + '&startTime=' + startTime + '&endTime=' + endTime + '&manual=' + manualType + '&isDesc=0';
