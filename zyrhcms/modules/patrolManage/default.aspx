<%@ Page Language="C#" MasterPageFile="~/master/mpMain.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="modules_patrolManage_default" %>
        ...
        <div id="bodyMain">
            <div id="mainTitle" class="titlebar">
                ...
                <div class="tools" style="_width:135px;*width:135px;">
                    <span id="timeboard" class="timeboard btn btnc22" onclick="refresh();"><span><b id="ts" class="ts"></b>秒后刷新</span></span>
                    ...
                    <%if(ui.UserId==1 || ui.UserName.Equals("admin")){%>
                        <a class="ibtn" id="btnDebug" title="调试" onclick="showDebugInfo();" style="float:right;"><i class="icon-debug"></i></a>
                    <%}%>
                </div>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/patrolManage/patrol.manage.js?<%=Public.NoCache()%>"></script>
<script type="text/javascript" src="<%=Public.WebDir%>/js/patrolManage/patrol.point.js?<%=Public.NoCache()%>"></script>
</asp:Content>