<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZGLD.aspx.cs" Inherits="modules_safety_control_ZGLD" %>
...
<script type="text/javascript">
    ...
    var tabs = [
        {code: 'form', name: '汇报主管领导', objName: 'divForm', load: false},
    ...
    var getAddressList = function(){
        ...
        var urlparam = 'action=getAddressList&deptType=1' + '&searchType=' + strSearchType + '&keywords=' + escape(strKeywords) + '&isLeader=1'
