<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DKKG.aspx.cs" Inherits="modules_safety_control_DKKG" %>
...
<body>
    <div id="mainContent" class="" style="background:#fff;">
        ...
        <div class="operbar" style="border-top:solid 1px #99bbe8; text-align:left;padding:0 10px; line-height:26px;">断开远动开关</div>
        <div style="padding:5px 10px;">
        <table border="0" cellpadding="0" cellspacing="0" class="tbform">
            <tr>
                <td rowspan="2" style="width:35px;">断开</td>
                <td style="width:70px;"><label><input id="rbLineType1" type="radio" name="rbLineType" value="1" checked="checked" />自闭线</label></td>
                <td rowspan="2"><select id="ddlStation" class="select" style="margin: 0 2px;"><option value="">选择车站</option></select>站 开关</td>
            </tr>
            <tr>
...
var getStation = function(){
    ...
    getRailwayStation(lineId, strKeywords, ddl);
};
...
var saveContent = function(isClose){
    ...
    strResult += strLineType + ' ' + strStation + '站 开关';
