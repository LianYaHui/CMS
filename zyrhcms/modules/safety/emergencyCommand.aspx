<%@ Page Language="C#" MasterPageFile="~/master/mpPlan.master" AutoEventWireup="true" CodeFile="emergencyCommand.aspx.cs" Inherits="modules_safety_emergencyCommand" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" Runat="Server">
    ...
    <%if(isInLAN){%><script type="text/javascript">var strImgPathDir = '<%=strImgPathDir%>';</script><%}%>
</asp:Content>
                ...
                <div class="box-panel" id="common_form">
                    <table>
                        <tr>
                            <td>部门：</td>
                            <td>
                                <input id="txtDepartmentId" type="hidden" style="float:right;width:238px;" class="txt w40" />
...
<script type="text/javascript">
    cms.frame.setHeaderDisplay();
    var strHtml = '<ul>'
        + '<li><a href="#">应急指挥</a></li>'
        + '<li class="right"><a href="#" onclick="exit();">退出</a></li>'
        + '</ul>';
    $('#nav').html(strHtml);
</script>
<script type="text/javascript" src="<%=Public.WebDir%>/js/safety/safety_tree.js?<%=Public.NoCache()%>"></script>
<script type="text/javascript" src="<%=Public.WebDir%>/js/safety/command.js?<%=Public.NoCache()%>"></script>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/safety/emergencyplan.js?<%=Public.NoCache()%>"></script>
<script type="text/javascript" src="<%=Public.WebDir%>/js/safety/accident.js?<%=Public.NoCache()%>"></script>
...
<%}%>
<script type="text/javascript" src="<%=Public.WebDir%>/js/safety/landmark.js?<%=Public.NoCache()%>"></script>
