<%@ Page Language="C#" MasterPageFile="~/master/mpPlan.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="modules_safety_default" %>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/safety/default.js?<%=Public.NoCache()%>"></script>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/safety/workplan_home.js?<%=Public.NoCache()%>"></script>
<%if (!isInLAN){%>
