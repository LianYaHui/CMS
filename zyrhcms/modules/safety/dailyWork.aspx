<%@ Page Language="C#" MasterPageFile="~/master/mpPlan.master" AutoEventWireup="true" CodeFile="dailyWork.aspx.cs" Inherits="modules_safety_dailyWork" %>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/safety/dailywork.js?<%=Public.NoCache()%>"></script>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/safety/workplan.js?<%=Public.NoCache()%>"></script>
<%if (!isInLAN){%>
