<%@ Page Language="C#" AutoEventWireup="true" CodeFile="planList.aspx.cs" Inherits="modules_safety_planList" %>
...
<script type="text/javascript">
    ...
    var initialForm = function(pid){
        ...
        var strHtml = '<div style="height:60px;background:#dbebfe;padding:0 5px;">'
            ...
            + '<tr>'
            + '<td>关键字：</td>'
            + '<td><input type="text" class="txt w135" maxlength="32" id="txtPlanKeywords" />'
    ...
    var buildPlanList = function(jsondata, strKeywords){
        var objList = cms.util.$('divPlanList');
