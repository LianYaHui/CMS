<%@ Page Language="C#" MasterPageFile="~/master/mpMain.master" AutoEventWireup="true" CodeFile="planManage.aspx.cs" Inherits="modules_safety_planManage" %>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/planManage/planManage.js"></script></asp:Content>