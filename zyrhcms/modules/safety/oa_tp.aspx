<%@ Page Language="C#" MasterPageFile="~/master/mpPlan.master" AutoEventWireup="true" CodeFile="oa_tp.aspx.cs" Inherits="modules_safety_oa_tp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" Runat="Server">
    ...
    <%if(isInLAN){%><script type="text/javascript">var strImgPathDir = '<%=strImgPathDir%>';var strMenuCode = '<%=strMenuCode%>';var strToday = '<%=DateTime.Now.ToString("yyyy-MM-dd")%>';</script><%}%>
</asp:Content>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/safety/oa_tp.js?<%=Public.NoCache()%>"></script>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/safety/dutyplan.js?<%=Public.NoCache()%>"></script>
<%if (!isInLAN){%>
