<%@ Page Language="C#" MasterPageFile="~/master/mpMain.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="modules_infoManage_default" %>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/info/info.js"></script>
<script type="text/javascript" src="<%=Public.WebDir%>/js/info/info.tree.js"></script>
<script type="text/javascript" src="<%=Public.WebDir%>/js/info/info.frame.js"></script></asp:Content>