<%@ Page Language="C#" MasterPageFile="~/master/mpPage.master" AutoEventWireup="true" CodeFile="loginBg.aspx.cs" Inherits="modules_config_loginBg" %>
    ...
    <div id="bodyContent">
        <div class="form">
            <form id="Form1" action="" runat="server" method="post">
                选择图片（图片尺寸: 800px × 320px，图片格式: .png|.jpg|.gif）<br />
                <asp:FileUpload ID="fileLoginBg" runat="server" CssClass="txt" />
                ...
                <br />
                当前图片：
                <div style="max-width:900px;max-height:400px;overflow:auto;">
                    <asp:Image ID="imgLoginBg" runat="server" style="display:block;" />
                </div>
