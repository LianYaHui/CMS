<%@ Page Language="C#" MasterPageFile="~/master/mpMain.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="modules_user_default" %>
        ...
        <div id="bodyMain">
            ...
            <div id="mainContent">
                <div id="operBar" class="operbar">
                    <div class="formpanel" style="padding:0;width:300px;">
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/user/user.js?<%=Public.NoCache()%>"></script></asp:Content>