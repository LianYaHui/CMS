<%@ Page Language="C#" MasterPageFile="~/master/mpMain.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="modules_sms_default" %>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/sms/sms.js"></script>
<script type="text/javascript" src="<%=Public.WebDir%>/js/sms/sms.tree.js"></script>
<script type="text/javascript" src="<%=Public.WebDir%>/js/sms/sms.frame.js"></script>
</asp:Content>