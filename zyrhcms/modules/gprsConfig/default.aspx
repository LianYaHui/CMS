<%@ Page Language="C#" MasterPageFile="~/master/mpMain.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="modules_gprsConfig_default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
    <div id="bodyContent">
		...
		<div id="bodyRight">
			...
			<div class="gprsConfigForm" id="bodyForm"></div>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/gprsConfig/gprsConfigTree.js?<%=Public.NoCache()%>"></script>
...
<script type="text/javascript" src="<%=Public.WebDir%>/common/js/pagination/pagination.js"></script></asp:Content>