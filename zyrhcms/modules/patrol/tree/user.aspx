<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user.aspx.cs" Inherits="modules_patrol_tree_user" %>
...
var loadTree = function(unitId){
    pwtree.buildTree($('#tree'), {treeType:'user',unitId:unitId, showCheckBox:false, callBack: 'setUser'});
}

var setUser = function(param){
    parent.setUser(param);
}
</script>
