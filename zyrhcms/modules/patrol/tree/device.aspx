<%@ Page Language="C#" AutoEventWireup="true" CodeFile="device.aspx.cs" Inherits="modules_patrol_tree_device" %>
...
var loadTree = function(unitId){
    pwtree.buildTree($('#tree'), {treeType:'device', unitId:unitId, showCheckBox:false, callBack: 'setDevice'});
}

var setDevice = function(param){
    parent.setDevice(param);
}
</script>