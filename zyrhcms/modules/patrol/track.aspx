<%@ Page Language="C#" AutoEventWireup="true" CodeFile="track.aspx.cs" Inherits="modules_patrol_track" %>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/patrol/patrol.track.js?<%=Public.NoCache()%>"></script>