<%@ Page Language="C#" AutoEventWireup="true" CodeFile="taskList.aspx.cs" Inherits="modules_patrol_taskList" %>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/patrol/patrol.task.js?<%=Public.NoCache()%>"></script>