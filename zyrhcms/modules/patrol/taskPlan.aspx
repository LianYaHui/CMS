<%@ Page Language="C#" AutoEventWireup="true" CodeFile="taskPlan.aspx.cs" Inherits="modules_patrol_taskPlan" %>
...
<script type="text/javascript" src="<%=Public.WebDir%>/js/patrol/patrol.plan.js?<%=Public.NoCache()%>"></script>