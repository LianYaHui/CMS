<%@ Page Language="C#" MasterPageFile="~/master/mpMain.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="modules_playback1_default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" Runat="Server">
    ...
    <script type="text/javascript">var isWindow = false;</script>
</asp:Content>
                ...
                <div id="divSearchForm">
                    ...
                    <table cellpadding="0" cellspacing="0" class="tbform" style="margin:2px 0 0 5px;">
                        <tr>
                            ...
                            <td class="w165"><input type="text" id="txtDevName" class="txt w150 disabled" value="" readonly="readonly" /></td>
                            <td class="w60">监控通道：</td>
                            <td><input type="text" id="txtChannelName" class="txt w150 disabled" value="" readonly="readonly" /></td>
                        </tr>
                        <tr>
                            <td>回放类型：</td>
