<%@ Page Language="C#" MasterPageFile="~/master/mpMain.master" AutoEventWireup="true" CodeFile="gpsTrack.aspx.cs" Inherits="modules_gpsTrack_gpsTrack" %>
...
<%}%>
<script type="text/javascript" src="<%=Public.WebDir%>/js/gpsTrack/gpsTrack_win.js?<%=Public.NoCache()%>"></script>
</asp:Content>